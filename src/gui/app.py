...
FIELD_LABELS: dict[str, str] = {
    ...
    'tp_rsi_long': 'TP Order RSI Long (0=same as exit)',
    'tp_rsi_short': 'TP Order RSI Short (0=same as exit)',
    ...
    def _get_field_groups(self) -> dict[str, list[str]]:
        ...
        if bot_type == 'sniper':
            return {
                ...
                'RSI Exit (Mean Revert)': ['exit_rsi_long', 'exit_rsi_short', 'adaptive_exit_enabled',
                                           'exit_rsi_trend_threshold', 'exit_rsi_trend_shift'],
                'TP Order (Spike Catcher)': ['tp_rsi_long', 'tp_rsi_short', 'tp_fallback_atr_mult'],
